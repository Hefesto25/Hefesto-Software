...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with provided credentials and submit the form (press Enter). Then wait for the page to respond and the dashboard to load.
        ...
        assert "Login" in await frame.title()
        # Verify URL contains "/"
        assert "/" in frame.url
        # Verify text "Comercial" is visible
