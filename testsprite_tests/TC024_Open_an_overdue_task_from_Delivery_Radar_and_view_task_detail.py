...
async def run_test():
    ...
    try:
        ...
        # -> Input the username into the email field (index 8).
        ...
        # -> Click the first overdue task in the Delivery Radar to open its detail view and then verify 'Task Details' and 'Status' are visible.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        # The expected text "Task Details" is not present in the available elements for this page.
        raise AssertionError('Feature missing: expected text "Task Details" not found on page. Marking task as done.')
